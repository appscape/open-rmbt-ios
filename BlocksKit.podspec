# Overriden not to include UIImagePickerController+BlocksKit to avoid iTunes Connect rejection because of missing privacy warnings
...
Pod::Spec.new do |s|
  ...
  s.subspec 'UIKit' do |ss|
    ...
    ss.exclude_files = 'BlocksKit/UIKit/UIImagePickerController*.{h,m}'
  end
end